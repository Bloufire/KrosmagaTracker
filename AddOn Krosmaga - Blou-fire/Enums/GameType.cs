...
namespace AddOn_Krosmaga___Blou_fire.Enums
{
	...
	{
		[Description("Random Ranked")] RANDOM_RANKED = 1,
		...
		[Description("Tutorial 3")] TUTORIAL_STEP_3 = 7,
		[Description("Friendly")] FRIENDLY = 8,
		[Description("Dungeon")] DUNGEON_ROOM = 9,
		[Description("Unlock Eca")] UNLOCK_ECAFLIP = 10,
		[Description("Unlock Eni")] UNLOCK_ENIRIPSA = 11,
		[Description("Unlock Sacri")] UNLOCK_SACRIER = 12,
		[Description("Unlock Xel")] UNLOCK_XELOR = 13,
		[Description("Unlock Sram")] UNLOCK_SRAM = 14,
