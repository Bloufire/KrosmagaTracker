...
namespace AddOn_Krosmaga___Blou_fire.Builders
{
    class GameStarted
    {
        ...
        public int BoardColumnsCount
        {
            get
            {
                return _boardColumnsCount;
            }

            set
            {
                _boardColumnsCount = value;
            }
        }
        ...
        public int BoardRowsCount
        {
            get
            {
                return _boardRowsCount;
            }

            set
            {
                _boardRowsCount = value;
            }
        }
        ...
        public int OpponentCardsCount
        {
            get
            {
                return _opponentCardsCount;
            }

            set
            {
                _opponentCardsCount = value;
            }
        }
        ...
        public int DofusBaseLife
        {
            get
            {
                return _dofusBaseLife;
            }

            set
            {
                _dofusBaseLife = value;
            }
        }
        ...
        public int DraftAllInOwnAmount
        {
            get
            {
                return _draftAllInOwnAmount;
            }

            set
            {
                _draftAllInOwnAmount = value;
            }
        }
        ...
        public int DraftAllInOpponentAmount
        {
            get
            {
                return _draftAllInOpponentAmount;
            }

            set
            {
                _draftAllInOpponentAmount = value;
            }
        }
