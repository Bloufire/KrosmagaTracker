...
namespace AddOn_Krosmaga___Blou_fire.Builders.EventsManager
{
	class CardMovedEvent
	{
		...
		{
			get { return _concernedFighter; }

			set { _concernedFighter = value; }
		}
		...
		{
			get { return _tradingCard; }

			set { _tradingCard = value; }
		}

		public CardLocation CardLocationFrom
		{
			get { return _cardLocationFrom; }

			set { _cardLocationFrom = value; }
		}

		public CardLocation CardLocationTo
		{
			get { return _cardLocationTo; }

			set { _cardLocationTo = value; }
		}
