...
namespace AddOn_Krosmaga___Blou_fire.Builders
{
	class GameFinished
	{
		...
		{
			get { return _loserPlayer; }

			set { _loserPlayer = value; }
		}
		...
		{
			get { return _resultHandlerType; }

			set { _resultHandlerType = value; }
		}

		public int ResultHandlerCount
		{
			get { return _resultHandlerCount; }

			set { _resultHandlerCount = value; }
		}
				...
				else
				{
					...
					if (tag != 32)
					{
						switch (tag)
						{
							case 40:
							case 42:
								ResultHandlerType.Add((Enums.ResultHandlerType) Enum.Parse(typeof(Enums.ResultHandlerType),
