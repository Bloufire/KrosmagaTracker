...
namespace AddOn_Krosmaga___Blou_fire.Data
{
    class DeckInfo
    {
        ...
        public List<uint> CardsWithQty1List
        {
            get
            {
                return _cardsWithQty1List;
            }

            set
            {
                _cardsWithQty1List = value;
            }
        }
        ...
        public int CardsWithQty1Count
        {
            get
            {
                return _cardsWithQty1Count;
            }

            set
            {
                _cardsWithQty1Count = value;
            }
        }
        ...
        public List<uint> CardsWithQty2List
        {
            get
            {
                return _cardsWithQty2List;
            }

            set
            {
                _cardsWithQty2List = value;
            }
        }
        ...
        public int CardsWithQty2Count
        {
            get
            {
                return _cardsWithQty2Count;
            }

            set
            {
                _cardsWithQty2Count = value;
            }
        }
        ...
        public List<uint> CardsWithQty3List
        {
            get
            {
                return _cardsWithQty3List;
            }

            set
            {
                _cardsWithQty3List = value;
            }
        }
        ...
        public int CardsWithQty3Count
        {
            get
            {
                return _cardsWithQty3Count;
            }

            set
            {
                _cardsWithQty3Count = value;
            }
        }
