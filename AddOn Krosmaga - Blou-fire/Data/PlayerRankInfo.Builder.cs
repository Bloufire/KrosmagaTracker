...
namespace AddOn_Krosmaga___Blou_fire.Data
{
	class PlayerRankInfo
	{
		...
		{
			get { return _hasFloorXpForLevel; }

			set { _hasFloorXpForLevel = value; }
		}

		public int FloorXpForLevel
		{
			get { return _floorXpForLevel; }

			set { _floorXpForLevel = value; }
		}

		public bool HasCeilXpForLevel
		{
			get { return _hasCeilXpForLevel; }

			set { _hasCeilXpForLevel = value; }
		}

		public int CeilXpForLevel
		{
			get { return _ceilXpForLevel; }

			set { _ceilXpForLevel = value; }
		}
		...
		{
			get { return _hasBestLevel; }

			set { _hasBestLevel = value; }
		}

		public int BestLevel
		{
			get { return _bestLevel; }

			set { _bestLevel = value; }
		}
